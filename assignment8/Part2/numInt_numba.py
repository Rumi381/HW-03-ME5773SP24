...
This script performs the numerical integration for the HW 8 assignment. Has
    numba-enabled functions
...
if __name__ == '__main__':
    ...
    F = integral_riemann(a,b,4)
    # Perform a dummy call to allow jit to compile before running the whole 
    #   thing
